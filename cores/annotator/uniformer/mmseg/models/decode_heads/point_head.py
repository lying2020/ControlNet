...
from cores.annotator.uniformer.mmcv.cnn import ConvModule, normal_init
from cores.annotator.uniformer.mmcv.ops import point_sample

from cores.annotator.uniformer.mmseg.models.builder import HEADS
