...
from cores.annotator.uniformer.mmcv.cnn import CONV_LAYERS, ConvAWS2d, constant_init
from cores.annotator.uniformer.mmcv.ops.deform_conv import deform_conv2d
from cores.annotator.uniformer.mmcv.utils import TORCH_VERSION, digit_version
