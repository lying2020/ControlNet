...
from cores.annotator.uniformer.mmcv.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from cores.annotator.uniformer.mmcv.engine import single_gpu_test
...
class DistEvalHook(EvalHook):
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from cores.annotator.uniformer.mmcv.engine import multi_gpu_test
