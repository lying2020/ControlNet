...
def collect_env():
    ...
    if cuda_available:
        ...
        from cores.annotator.uniformer.mmcv.utils.parrots_wrapper import _get_cuda_home
    ...
    try:
        from cores.annotator.uniformer.mmcv.ops import get_compiler_version, get_compiling_cuda_version
    except ModuleNotFoundError:
