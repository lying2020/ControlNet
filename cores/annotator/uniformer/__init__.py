...
from cores.annotator.uniformer.mmseg.apis import init_segmentor, inference_segmentor, show_result_pyplot
from cores.annotator.uniformer.mmseg.core.evaluation import get_palette
from cores.annotator.util import annotator_ckpts_path
